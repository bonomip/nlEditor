...
public class LessSlice extends Slice {
  public LessSlice() {
    importSyntax("neverlang.commons.expressions.rel.lt.LessSyntax");
        imports("neverlang.commons.expressions.rel.lt.LessEvaluation", 
    ...
    imports("neverlang.commons.expressions.promotion.StringPromotion", 
         role("type_promotion"));
    imports("neverlang.commons.expressions.rel.lt.LessSyntax", 
