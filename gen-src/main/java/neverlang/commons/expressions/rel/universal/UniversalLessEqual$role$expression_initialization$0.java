...
public class UniversalLessEqual$role$expression_initialization$0 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> getRequiredNtAttributes() {
    return java.util.Map.ofEntries(
      new java.util.AbstractMap.SimpleImmutableEntry<java.lang.Integer, java.util.Set<java.lang.String>>(1, java.util.Set.of( "expr" ) ),
  ...
  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Comparable> leftExpr = $ctx.nt(1).getValue("expr");
    Supplier<java.lang.Comparable> rightExpr = $ctx.nt(2).getValue("expr");
