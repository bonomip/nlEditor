...
public class SubtractionEvaluation$role$expression_initialization$0_0 implements PostorderSemanticAction, java.io.Serializable {
  ...
  @Override
  public java.lang.String getLabel() { return "subtraction"; }
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(1).getValue("type").equals(java.lang.Double.class) && $ctx.nt(2).getValue("type").equals(java.lang.Double.class) ;} catch (UndefinedAttributeException e) { return false; }
  }

  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Double> leftExpr = $ctx.nt(1).getValue("expr");
    Supplier<java.lang.Double> rightExpr = $ctx.nt(2).getValue("expr");
    Supplier<java.lang.Double> expr = () -> leftExpr.get() - rightExpr.get();
    $ctx.nt(0).setValue("type",  java.lang.Double.class);
