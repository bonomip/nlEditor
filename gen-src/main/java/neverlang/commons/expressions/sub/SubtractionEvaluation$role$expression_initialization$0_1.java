...
public class SubtractionEvaluation$role$expression_initialization$0_1 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(1).getValue("type").equals(java.lang.Float.class) && $ctx.nt(2).getValue("type").equals(java.lang.Float.class) ;} catch (UndefinedAttributeException e) { return false; }
  }

  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Float> leftExpr = $ctx.nt(1).getValue("expr");
    Supplier<java.lang.Float> rightExpr = $ctx.nt(2).getValue("expr");
    Supplier<java.lang.Float> expr = () -> leftExpr.get() - rightExpr.get();
    $ctx.nt(0).setValue("type",  java.lang.Float.class);
