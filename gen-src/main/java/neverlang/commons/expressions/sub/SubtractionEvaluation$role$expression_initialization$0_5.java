...
public class SubtractionEvaluation$role$expression_initialization$0_5 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(1).getValue("type").equals(java.lang.Character.class) && $ctx.nt(2).getValue("type").equals(java.lang.Character.class) ;} catch (UndefinedAttributeException e) { return false; }
  }

  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Character> leftExpr = $ctx.nt(1).getValue("expr");
    Supplier<java.lang.Character> rightExpr = $ctx.nt(2).getValue("expr");
