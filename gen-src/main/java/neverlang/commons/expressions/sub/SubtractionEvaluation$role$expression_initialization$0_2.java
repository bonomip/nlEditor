...
public class SubtractionEvaluation$role$expression_initialization$0_2 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(1).getValue("type").equals(java.lang.Long.class) && $ctx.nt(2).getValue("type").equals(java.lang.Long.class) ;} catch (UndefinedAttributeException e) { return false; }
  }

  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Long> leftExpr = $ctx.nt(1).getValue("expr");
    Supplier<java.lang.Long> rightExpr = $ctx.nt(2).getValue("expr");
