...
public class UnaryComplement$role$expression_initialization$0_3 implements PostorderSemanticAction, java.io.Serializable {
  ...
  @Override
  public java.lang.String getLabel() { return "complement"; }
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(1).getValue("type").equals(java.lang.Character.class) ;} catch (UndefinedAttributeException e) { return false; }
  }
