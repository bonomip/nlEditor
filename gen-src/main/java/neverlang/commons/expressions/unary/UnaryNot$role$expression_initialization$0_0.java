...
public class UnaryNot$role$expression_initialization$0_0 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Boolean> oldExpr = $ctx.nt(1).getValue("expr");
