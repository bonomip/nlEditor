...
public class UnaryComplement$role$expression_initialization$0_4 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    BadOperandTypesException error = new BadOperandTypesException($n.tchild(0).token.row, $n.tchild(0).token.col, "~", $ctx.nt(1).getValue("type"));
