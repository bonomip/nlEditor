...
public class LongPromotion$role$type_promotion$0_0 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(2).getValue("type").equals(java.lang.Long.class) && $ctx.nt(1).getValue("type").equals(java.lang.Double.class) ;} catch (UndefinedAttributeException e) { return false; }
  }

  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Long> oldExpr = $ctx.nt(2).getValue("expr");
