...
public class BytePromotion$role$type_promotion$0_8 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(2).getValue("type").equals(java.lang.Byte.class) && $ctx.nt(1).getValue("type").equals(java.lang.Short.class) ;} catch (UndefinedAttributeException e) { return false; }
  }
  ...
  public void apply(Context $ctx) {
    ...
    $ctx.nt(2).setValue("type",  java.lang.Short.class);
