...
public class CharPromotion$role$type_promotion$0_4 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(2).getValue("type").equals(java.lang.Character.class) && $ctx.nt(1).getValue("type").equals(java.lang.Long.class) ;} catch (UndefinedAttributeException e) { return false; }
  }
  ...
  public void apply(Context $ctx) {
    ...
    $ctx.nt(2).setValue("type",  java.lang.Long.class);
