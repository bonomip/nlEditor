...
public class ShortPromotion$role$type_promotion$0_6 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(2).getValue("type").equals(java.lang.Short.class) && $ctx.nt(1).getValue("type").equals(java.lang.Integer.class) ;} catch (UndefinedAttributeException e) { return false; }
  }

  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Short> oldExpr = $ctx.nt(2).getValue("expr");
