...
public class BytePromotion$role$type_promotion$0_2 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(2).getValue("type").equals(java.lang.Byte.class) && $ctx.nt(1).getValue("type").equals(java.lang.Float.class) ;} catch (UndefinedAttributeException e) { return false; }
  }
