...
public class StringPromotion$role$type_promotion$0_1 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Object> oldExpr = $ctx.nt(2).getValue("expr");
    Supplier<java.lang.String> newExpr = () -> oldExpr.get().toString();
    $ctx.nt(2).setValue("type",  java.lang.String.class);
