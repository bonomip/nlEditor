...
public class StringPromotion$role$type_promotion$0_0 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Object> oldExpr = $ctx.nt(1).getValue("expr");
    Supplier<java.lang.String> newExpr = () -> oldExpr.get().toString();
    $ctx.nt(1).setValue("type",  java.lang.String.class);
