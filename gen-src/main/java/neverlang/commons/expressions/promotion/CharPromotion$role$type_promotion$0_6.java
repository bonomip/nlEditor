...
public class CharPromotion$role$type_promotion$0_6 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(2).getValue("type").equals(java.lang.Character.class) && $ctx.nt(1).getValue("type").equals(java.lang.Integer.class) ;} catch (UndefinedAttributeException e) { return false; }
  }

  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Character> oldExpr = $ctx.nt(2).getValue("expr");
    Supplier<java.lang.Integer> newExpr = () -> new java.lang.Integer(oldExpr.get().charValue());
    $ctx.nt(2).setValue("type",  java.lang.Integer.class);
