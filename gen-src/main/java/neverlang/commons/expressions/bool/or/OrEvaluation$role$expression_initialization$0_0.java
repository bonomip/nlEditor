...
public class OrEvaluation$role$expression_initialization$0_0 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(1).getValue("type").equals(java.lang.Boolean.class) && $ctx.nt(2).getValue("type").equals(java.lang.Boolean.class) ;} catch (UndefinedAttributeException e) { return false; }
  }

  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.Boolean> leftExpr = $ctx.nt(1).getValue("expr");
    Supplier<java.lang.Boolean> rightExpr = $ctx.nt(2).getValue("expr");
