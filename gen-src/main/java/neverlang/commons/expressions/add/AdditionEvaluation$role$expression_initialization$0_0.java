...
public class AdditionEvaluation$role$expression_initialization$0_0 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public boolean predicate(Context $ctx) {
    ASTNode $n = $ctx.node();
    try {return  $ctx.nt(1).getValue("type").equals(java.lang.String.class) && $ctx.nt(2).getValue("type").equals(java.lang.String.class) ;} catch (UndefinedAttributeException e) { return false; }
  }

  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    Supplier<java.lang.String> leftExpr = $ctx.nt(1).getValue("expr");
    Supplier<java.lang.String> rightExpr = $ctx.nt(2).getValue("expr");
    Supplier<java.lang.String> expr = () -> leftExpr.get() + rightExpr.get();
    $ctx.nt(0).setValue("type",  java.lang.String.class);
