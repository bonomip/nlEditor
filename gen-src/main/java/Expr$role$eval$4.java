...
public class Expr$role$eval$4 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> getRequiredNtAttributes() {
    return java.util.Map.ofEntries(
      new java.util.AbstractMap.SimpleImmutableEntry<java.lang.Integer, java.util.Set<java.lang.String>>(4, java.util.Set.of( "value" ) )
    );
  }
  ...
  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    $ctx.nt(4).setValue("value",  (Integer) $ctx.nt(4).getValue("value"));
