...
public class ProdExpr$role$eval$0 implements PostorderSemanticAction, java.io.Serializable {
  ...
  public java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> getProvidedNtAttributes() {
    return java.util.Map.ofEntries(
      new java.util.AbstractMap.SimpleImmutableEntry<java.lang.Integer, java.util.Set<java.lang.String>>(0, java.util.Set.of( "value" ) )
    );
  }
  ...
  public void apply(Context $ctx) {
    ASTNode $n = $ctx.node();
    $ctx.nt(0).setValue("value",  (Integer) $ctx.nt(1).getValue("value") * (Integer) $ctx.nt(2).getValue("value"));
