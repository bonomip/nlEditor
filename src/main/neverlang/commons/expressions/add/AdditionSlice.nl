slice neverlang.commons.expressions.add.AdditionSlice {
    concrete syntax from neverlang.commons.expressions.add.AdditionSyntax
    module neverlang.commons.expressions.add.AdditionEvaluation with role expression-initialization
    ...
    module neverlang.commons.expressions.add.AdditionSyntax with role terminal-evaluation
