module neverlang.commons.expressions.bitwise.lshift.LeftShiftEvaluation {
    imports {
        java.util.function.Supplier;
        neverlang.commons.expressions.errors.*;
        neverlang.commons.errors.ErrorReport;
    }
    reference syntax from neverlang.commons.expressions.bitwise.lshift.LeftShiftSyntax
