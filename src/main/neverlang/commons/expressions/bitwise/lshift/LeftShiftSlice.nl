slice neverlang.commons.expressions.bitwise.lshift.LeftShiftSlice {
    concrete syntax from neverlang.commons.expressions.bitwise.lshift.LeftShiftSyntax
    module neverlang.commons.expressions.bitwise.lshift.LeftShiftEvaluation with role expression-initialization
    ...
    module neverlang.commons.expressions.bitwise.lshift.LeftShiftSyntax with role terminal-evaluation
