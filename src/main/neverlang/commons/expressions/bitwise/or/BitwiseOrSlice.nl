slice neverlang.commons.expressions.bitwise.or.BitwiseOrSlice {
    concrete syntax from neverlang.commons.expressions.bitwise.or.BitwiseOrSyntax
    module neverlang.commons.expressions.bitwise.or.BitwiseOrEvaluation with role expression-initialization
    ...
    module neverlang.commons.expressions.bitwise.or.BitwiseOrSyntax with role terminal-evaluation
