slice neverlang.commons.expressions.bitwise.ushift.UnsignedShiftSlice {
    concrete syntax from neverlang.commons.expressions.bitwise.ushift.UnsignedShiftSyntax
    module neverlang.commons.expressions.bitwise.ushift.UnsignedShiftEvaluation with role expression-initialization
    ...
    module neverlang.commons.expressions.bitwise.ushift.UnsignedShiftSyntax with role terminal-evaluation
