module neverlang.commons.expressions.bitwise.rshift.RightShiftEvaluation {
    imports {
        java.util.function.Supplier;
        neverlang.commons.expressions.errors.*;
        neverlang.commons.errors.ErrorReport;
    }
    reference syntax from neverlang.commons.expressions.bitwise.rshift.RightShiftSyntax
