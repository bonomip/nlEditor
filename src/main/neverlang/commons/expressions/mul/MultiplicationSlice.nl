slice neverlang.commons.expressions.mul.MultiplicationSlice {
    concrete syntax from neverlang.commons.expressions.mul.MultiplicationSyntax
    module neverlang.commons.expressions.mul.MultiplicationEvaluation with role expression-initialization
    ...
    module neverlang.commons.expressions.mul.MultiplicationSyntax with role terminal-evaluation
