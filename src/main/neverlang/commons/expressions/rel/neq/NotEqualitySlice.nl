slice neverlang.commons.expressions.rel.neq.NotEqualitySlice {
    concrete syntax from neverlang.commons.expressions.rel.neq.NotEqualitySyntax
    module neverlang.commons.expressions.rel.neq.NotEqualityEvaluation with role expression-initialization
    ...
    module neverlang.commons.expressions.rel.neq.NotEqualitySyntax with role terminal-evaluation
