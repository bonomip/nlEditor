slice neverlang.commons.expressions.rel.gteq.GreaterEqualSlice {
    concrete syntax from neverlang.commons.expressions.rel.gteq.GreaterEqualSyntax
    module neverlang.commons.expressions.rel.gteq.GreaterEqualEvaluation with role expression-initialization
    ...
    module neverlang.commons.expressions.rel.gteq.GreaterEqualSyntax with role terminal-evaluation
