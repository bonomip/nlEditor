slice neverlang.commons.expressions.rel.universal.UniversalLessSlice {
    concrete syntax from neverlang.commons.expressions.rel.lt.LessSyntax
    module neverlang.commons.expressions.rel.universal.UniversalLess with role expression-initialization translate
